...
class GlobalColors: NSObject {
    class var lightModeRegularKey: UIColor { get { return UIColor.whiteColor().colorWithAlphaComponent(CGFloat(0.7)) }}
...
class KeyboardLayout: NSObject, KeyboardKeyProtocol {
    ...
    func setAppearanceForKey(key: KeyboardKey, model: Key, darkMode: Bool, solidColorMode: Bool) {
        ...
        case
        Key.KeyType.Space:
            key.color = UIColor.yellowColor() //self.globalColors.regularKey(darkMode, solidColorMode: solidColorMode)
            key.downColor = self.globalColors.specialKey(darkMode, solidColorMode: solidColorMode)
            key.textColor = (darkMode ? self.globalColors.darkModeTextColor : self.globalColors.lightModeTextColor)
            key.downTextColor = nil
        case
        Key.KeyType.Shift:
            key.color = UIColor.redColor() //self.globalColors.specialKey(darkMode, solidColorMode: solidColorMode)
            key.downColor = (darkMode ? self.globalColors.darkModeShiftKeyDown : self.globalColors.lightModeRegularKey)
            key.textColor = UIColor.yellowColor() //self.globalColors.darkModeTextColor
        ...
        Key.KeyType.ModeChange:
            key.color = UIColor.redColor() //self.globalColors.specialKey(darkMode, solidColorMode: solidColorMode)
            key.downColor = nil
            key.textColor = UIColor.yellowColor() //(darkMode ? self.globalColors.darkModeTextColor : self.globalColors.lightModeTextColor)
            key.downTextColor = nil
        case
        Key.KeyType.Return,
